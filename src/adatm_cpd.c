    ...
    splatt_kruskal * factored)
{
  ...
  // jli: allocate the maximum space for each update factor matrix.
  ...
  factored->fit = cpd_als_iterate_adaptive(tensors, rs_seq, n_csf, grp_prop, n_grp, use_csfs, use_tags, mats, lambda, nfactors, &rinfo,
      options);
